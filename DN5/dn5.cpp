...
int main() {
    ...
    // podatke iz string-a, če so locirani z ' '
    ...
    // zato jo samo preberemo in ne naredimo ničesar. Poglejte v
    ...
    // Sedaj imamo A in b. Napišemo Gauss-Seidel metodo. Najprej
  // inicializiramo vektor rešitev T, npr. za 100 °C.
    vector<double> T;
...
#pragma omp for
    ...
    std::cout << "Najvišja temperatura: " << max_T << " °C" << std::endl;
